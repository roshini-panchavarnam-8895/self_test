...
:root {
  ...
  --lyte-accordion-header-font-size: 16px;
  --lyte-accordion-body-font-size: 14px;
}
/* rtl files loading */
...
lyte-radiobutton input[type="radio"]:checked + .lyteRadioCheckbox::after {
  -webkit-mask-image: url(/assets/images/sprite_lyte.svg);
  -webkit-mask-position: -33px -15px;
  mask-image: url(/assets/images/sprite_lyte.svg);
...
.lyteDateRangePickerRow .lyteCalyearNavLft,
.lyteDateRangePickerRow .lyteCalyearNavRgt {
  display: none;
}
/*------- Added by Sam-------*/
...
/* Loading theme in configuration */
:root {
  --lyte-buttong-group-fill-bg: #e0e1e2;
...
lyte-button-group .fillType lyte-button button.lyteDefaultBtn {
  border: 0;
  background: var(--lyte-buttong-group-fill-bg);
}
...
:root {
  ...
  --lyte-list-fake-header-bg: #fff;
  --Lyte-list-fake-cell-Odd-bg: #fff;
  --Lyte-list-fixed-bg: #f7f7f7;
  --Lyte-list-fixed-bg: #fff;
  --lyte-List-ResizeHandler-After-bg: #d7e2ed;
  --lyte-list-view-wrapper-td-border-bottom-color: #e2e2e2;
  --lyte-list-view-wrapper-td-bg: #fff;
  --lyte-list-view-wrapper-td-color: #111;
  --lyte-Listview-Wrapper-Td-bg: #f7f9fb;
  --lyte-ListEdit-Element-border-bg: #5ba1e5;
  --lyte-Multiselect-Filter-Table-border-color: #d6d6d6;
  --lyte-DateFilter-Disabled-Element-bg: #eee;
  --lyte-list-filters-border-color: #d6d6d6;
  --lyte-list-filter-key-color: #777;
  --lyte-ListFilter-Value-Wrap-border-color: #d6d6d6;
  --lyte-list-remove-filter-bg: #000;
  --lyte-list-remove-filter-hover-bg: #f00;
  --lyte-listview-table-accordian-icon-bg: #333;
  --lyte-group-heading-hover-bg: #f7f9fb;
  --lyte-group-heading-hover-td-bg: transparent;
}
/* rtl files loading */
/* Loading custom themes */
.lyteListUtils {
...
.lyteListFakeHeader {
  ...
  z-index: 30;
  transform: translateY(var(--lyte-table-intersection));
  background: var(--lyte-list-fake-header-bg);
  border-radius: 3px 3px 0 0;
}
.lyteListFakeCell {
  position: sticky;
...
.lyteListFakeCell:nth-child(odd) {
  background: var(--Lyte-list-fake-cell-Odd-bg);
}
...
.lyteListFixed {
  background: var(--Lyte-list-fixed-bg);
  z-index: 20;
}
...
.lyteListResizeHandler::after {
  ...
  display: block;
  width: 2px;
  background: var(--lyte-List-ResizeHandler-After-bg);
}
...
.lyteListviewWrapper td {
  display: table-cell;
  border-bottom: 1px solid var(--lyte-list-view-wrapper-td-border-bottom-color);
  vertical-align: middle;
  background: var(--lyte-list-view-wrapper-td-bg);
  min-width: 50px;
  box-sizing: border-box;
  font-size: 15px;
  white-space: nowrap;
  color: var(--lyte-list-view-wrapper-td-color);
}
...
.lyteListEditElement {
  position: absolute;
  display: none;
  border: 1px solid var(--lyte-ListEdit-Element-border-bg);
  outline: none;
  box-sizing: border-box;
  z-index: 50;
}
...
.lyteMultiselectFilterTable {
  ...
  margin-top: 10px;
  border-radius: 3px;
  border: 1px solid var(--lyte-Multiselect-Filter-Table-border-color);
}
...
.lyteDateFilterDisabledElement {
  ...
  background: var(--lyte-DateFilter-Disabled-Element-bg);
  border-radius: 2px;
}
/*	Lyte List view filter related CSS Ends	*/
/*	Lyte List view Filter Summary Begins	*/
.lyteListFilters {
  border: 1px solid var(--lyte-listfilters-border-color);
  padding: 5px;
  border-radius: 3px;
}
.lyteListFilterItem {
...
.lyteListFilterKey {
  color: var(--lyte-listfilter-key-color);
  margin-right: 5px;
}
.lyteListFilterValueWrap .lyteListMultipleSelected {
  padding: 1px 3px 3px;
  border: 1px solid var(--lyte-ListFilter-Value-Wrap-border-color);
  display: inline-block;
  border-radius: 3px;
  font-size: 13px;
}
.lyteListRemoveFilter {
  ...
  background-color: var(--lyte-list-remove-filter-bg);
  width: 8px;
  height: 8px;
  cursor: pointer;
  position: absolute;
...
.lyteListRemoveFilter:hover {
  background-color: var(--lyte-list-remove-filter-hover-bg);
}
...
.lyteGroupHeading:hover {
  background: var(--lyte-group-heading-hover-bg);
}
.lyteGroupHeading td,
.lyteGroupHeading:hover td {
  background: var(--lyte-group-heading-hover-td-bg);
}
...
/* Loading theme in configuration */
:root {
  --lyte-listview-filters-bg: #fff;
  --lyte-listview-filters-border-color: #d6d6d6;
  --lyte-listview-filter-focus-within-border-color: #0984e3;
  --lyte-listview-dropdown-ul-border-color: #e5e8ea;
  --lyte-listview-dropdown-ul-bg: #fff;
  --lyte-listview-dropdown-ul-boxshadow-color: rgba(0, 0, 0, 0.07);
  --lyte-listview-dropdown-ul-color: #152229;
  --lyte-filter-searchwrap-border-color: #AEDAF9;
  --lyte-input-filter-label-bg: #EAF3FA;
  --lyte-filter-column-name-bg: #F6FAFD;
  --lyte-filter-searchwrap-hover-bg: #0984E3;
  --lyte-listview-filter-clearicon-before-bg: #111;
  --lyte-Filter-SearchWrap-Hover-ListView-Filter-ClearIcon-Before-bg: #fff;
}
/* rtl files loading */
/* Loading custom themes */
...
.lyteListViewFilters {
  display: inline-flex;
  background: var(--lyte-listview-filters-bg);
  border: 1px solid var(--lyte-listview-filters-border-color);
  border-radius: 2px;
  padding: 4px 10px;
  gap: 5px;
}
.lyteListViewFilters:focus-within {
  border: 1px solid var(--lyte-listview-filter-focus-within-border-color);
...
.lyteListViewDropdownUl {
  list-style: none;
  border: 1px solid var(--lyte-listview-dropdown-ul-border-color);
  border-radius: 2px;
  background: var(--lyte-listview-dropdown-ul-bg);
  box-shadow: 0px 0px 8px 3px var(--lyte-listview-dropdown-ul-boxshadow-color);
  color: var(--lyte-listview-dropdown-ul-color);
  font-size: 14px;
  padding: 5px 0;
  min-width: 200px;
  max-width: 330px;
...
.lyteFilterSearchWrap {
  ...
  align-items: center;
  border-radius: 2px;
  border: 1px solid var(--lyte-filter-searchwrap-border-color);
  font-size: 13px;
  white-space: nowrap;
}
.lyteInputFilterLabel {
  padding: 4px;
  background: var(--lyte-input-filter-label-bg);
  border-radius: 1px 0 0 1px;
}
.lyteFilterColumnName {
  padding: 4px;
  background: var(--lyte-filter-column-name-bg);
}
.lyteFilterCondition {
  padding: 4px;
  outline: 0;
...
.lyteFilterSearchWrap:hover .lyteListViewFilterClearIcon {
  background: var(--lyte-filter-searchwrap-hover-bg);
}
.lyteListViewFilterClearIcon::before {
  ...
  mask-image: url(../images/sprite_lyte.svg);
  mask-position: -54px -2px;
  background-color: var(--lyte-listview-filter-clearicon-before-bg);
  width: 8px;
  height: 8px;
  display: inline-block;
}
.lyteFilterSearchWrap:hover .lyteListViewFilterClearIcon::before {
  background-color: var(--lyte-Filter-SearchWrap-Hover-ListView-Filter-ClearIcon-Before-bg);
}
/* Default theme imported */
@keyframes loop {
  50% {
...
.ltCustomLandmark {
  position: relative;
  outline: var(--lyte-landmark-border-size) solid var(--lyte-landmark-role-color);
}
.ltCustomLandmark::after {
  ...
  padding: 2px 4px;
  color: #fff;
  background-color: var(--lyte-landmark-role-color);
}
