 ...
 * Figma Source: Text_Input_Base (node 2165:32695)
 *
 * Handles interactive behavior for the text input component showcase:
 *   - Tab switching between input state variants
...
(function () {
    ...
    var INPUT_VARIANTS = {
        states: [
            ...
            { key: 'filled',     label: 'Filled',    cls: 'zc-input-wrapper-filled' },
            { key: 'focus',      label: 'Focus',     cls: 'zc-input-wrapper-focus' },
            { key: 'hover',      label: 'Hover',     cls: '' },
            { key: 'disabled',   label: 'Disabled',  cls: 'zc-input-wrapper-disabled' },
            { key: 'readonly',   label: 'Read-only', cls: 'zc-input-wrapper-readonly' },
            { key: 'error',      label: 'Error',     cls: 'zc-input-wrapper-error' },
            { key: 'success',    label: 'Success',   cls: 'zc-input-wrapper-success' },
            { key: 'with-icons', label: 'With Icons', cls: '' },
            { key: 'with-label', label: 'With Label', cls: '' }
        ]
    };

    window.INPUT_VARIANTS = INPUT_VARIANTS;

    /* -----------------------------------------------------------------------
       SWITCH INPUT STYLE TAB
       ----------------------------------------------------------------------- */
    window.switchInputStyleTab = function (styleKey, tabEl) {
        var container = document.getElementById('input-component-variants');
        if (!container) return;
    ...
    /* -----------------------------------------------------------------------
       COPY INPUT CODE
       ----------------------------------------------------------------------- */
    window.copyInputCode = function (btn) {
    ...
    /* -----------------------------------------------------------------------
       TOGGLE CODE PANEL
       ----------------------------------------------------------------------- */
    window.toggleInputCodePanel = function (btn) {
    ...
    /* -----------------------------------------------------------------------
       ...
       ----------------------------------------------------------------------- */
    window.switchInputCodeTab = function (tab, tabEl) {
