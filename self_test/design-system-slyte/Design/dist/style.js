        ...
        if (componentSrc && !specificView.dataset.componentLoaded) {
            ...
            function injectComponentHTML(html) {
                ...
                requestAnimationFrame(function() {
                    ...
                    if (typeof window.initZcButtons === 'function') {
                        window.initZcButtons(specificView);
                    }
                    if (typeof window.initZcGridLayout === 'function') {
                        window.initZcGridLayout(specificView);
                    }
                    if (typeof window.initZcBreadcrumbs === 'function') {
                        window.initZcBreadcrumbs(specificView);
                    }
                });
            }
