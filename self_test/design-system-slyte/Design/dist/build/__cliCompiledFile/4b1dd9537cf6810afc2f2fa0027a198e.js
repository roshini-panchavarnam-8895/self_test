import { Lyte, resolvePromises } from "../../core/index.js";
import { deepCopyObject } from "../../core/src/lyte-utils.js";
...
class Router extends Service {
    constructor(a) {
        ...
        function renderComp(outlet, component, {data, ins, registry }) {
        ...
        var routeOptions = {
			lyte,
			dispatch,
			render : function({outlet, component, data, html, reRender, registry}) {
				if(outlet = getOutlet(outlet,this.parent)) {
					...
					if(component) {
						if(component && !reRender && (!this.component || this.component.localName == component._compName) && this.outlet == outlet && outlet.contains(this.component)) {
							...
							triggerTemplateDestroy(obj,false);
							this.component = renderComp(outlet, component,{data, ins : this, registry : registry || LR.__lp.config.registry})
						}
					} else if(html) {
