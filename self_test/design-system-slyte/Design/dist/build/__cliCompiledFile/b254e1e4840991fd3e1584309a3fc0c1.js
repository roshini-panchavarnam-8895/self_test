...
import { extendEventListeners, isEntity, getSuperClass, newGetSuperClass, prop } from "../../core/src/lyte-utils.js";
import { DataType as DataTypeClass } from "../../core/index.js";
...
class Db extends Service {
    ...
    constructor(opts){
        ...
        this.cache = {
            ...
            getAll: function getAll(def){
                ...
                if(self.$app.$mutate){
                    return self.$app.$mutate.create(def.data);
                }
                return def.data;
            }
        }
    ...
    push(def,data,deserialize,index){
        ...
        //@Slicer.catchAllErrorsEnd
            ...
            return data && this.$app.$mutate ? this.$app.$mutate.create(data) : data;
        //@Slicer.catchAllErrorsStart
        }catch(err){
            Dberror.error(err);
        }
    ...
    newEntity(def, opts, skipValidation){
        ...
        //@Slicer.catchAllErrorsEnd
            ...
            return this.$app.$mutate ? this.$app.$mutate.create(data) : data;
        //@Slicer.catchAllErrorsStart
        }catch(err){
            Dberror.error(err);
        }
        ...
        var gPrm = prm.then(function(){
            ...
            //@Slicer.catchAllErrorsEnd
                ...
                if(data){
                    ...
                    return db.$app.$mutate ? db.$app.$mutate.create(data[name]) : data[name];	
                }
                return arguments;
            //@Slicer.catchAllErrorsStart
            }catch(err){
