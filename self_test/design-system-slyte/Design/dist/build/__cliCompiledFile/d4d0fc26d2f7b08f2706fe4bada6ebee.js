...
import {arrayUtils,objectUtils,set,appendChild,insertAfter,insertBefore,replaceWith} from "../../../../@slyte/component/index.js"
...
window.LyteColorbox = {
	 ...
	 */
	close : function () {
		this._component.ltPropShow = false;
	...
	addCropEvent : function(itemDiv){
		...
		cropBtns.forEach(function(cropBtn){
			cropBtn.addEventListener('click',function(event){
				...
				if(ratio){
					$L('.lyteCBoxVisible' ,itemDiv).cropper({'aspectRatio' : ratio});
					var cropper = $L('.lyteCropDivImage',itemDiv)[0];
...
class LyteColorboxComponent extends Component {
    ...
    getSelectorElements() {
		...
		for(var i = 0; i<selectors.length; i++){
			arrayUtils(ele,'push',Array.from(document.querySelectorAll(selectors[i])));
		}
		return ele;
	}
