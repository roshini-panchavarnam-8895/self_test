import { _delimit, _dynamicRouteCheck, _frameQueryParams, _getObj, _strPresence, _splitPath, _wildcardRouteCheck } from "./router-utils.js";
...
class RouterMap {
    ...
    route(routeName, obj, nestedFn) {
        ...
        var routes = _getObj(routeStringArr,_config.routes);
