...
var CARD_PREVIEWS = {
  ...
  'checkbox':         '<div class="cp-field cp-checks"><label>Options</label><div class="cp-check-group"><label class="cp-check"><input type="checkbox" checked><span>Option A</span></label><label class="cp-check"><input type="checkbox" disabled><span>Option B</span></label></div></div>',
  'radio-button':     '<div class="cp-field cp-checks"><label>Choice</label><div class="cp-check-group"><label class="cp-check"><input type="radio" name="cp-r" checked><span>Option 1</span></label><label class="cp-check"><input type="radio" name="cp-r" disabled><span>Option 2</span></label></div></div>',
  'decision-box':     '<div class="cp-field"><label class="cp-check"><input type="checkbox" checked=""><span>Decision box</span></label></div>',
  ...
  'file-upload':      '<div class="cp-field"><label>Attachment</label><div class="cp-upload cp-upload-inline"><span class="cp-upload-text">Select File</span><span class="cp-upload-actions"><i class="fa-solid fa-arrow-up-from-bracket"></i><i class="fa-solid fa-cloud-arrow-up"></i></span></div></div>',
  'image-upload':     '<div class="cp-field"><label>Photo</label><div class="cp-upload cp-upload-inline"><span class="cp-upload-text">Select Image</span><span class="cp-upload-actions"><i class="fa-solid fa-arrow-up-from-bracket"></i><i class="fa-solid fa-link"></i><i class="fa-solid fa-camera"></i></span></div></div>',
  'audio-upload':     '<div class="cp-field"><label>Audio</label><div class="cp-upload cp-upload-inline"><span class="cp-upload-text">Select File</span><span class="cp-upload-actions"><i class="fa-solid fa-arrow-up-from-bracket"></i><i class="fa-solid fa-microphone"></i></span></div></div>',
  'video-upload':     '<div class="cp-field"><label>Video</label><div class="cp-upload cp-upload-inline"><span class="cp-upload-text">Select File</span><span class="cp-upload-actions"><i class="fa-solid fa-arrow-up-from-bracket"></i><i class="fa-solid fa-video"></i></span></div></div>',
...
.zc-radio-input { appearance: none; -webkit-appearance: none; width: 18px; height: 18px; border: 1px solid var(--color-border); border-radius: 50%; cursor: pointer; position: relative; flex-shrink: 0; transition: border-color 0.2s ease; }
...
w('.cp-tag { display: inline-flex; align-items: center; gap: 4px; padding: 4px 10px; background: #f9fafc; color: #333; border: 1px solid #e0dce8; border-radius: 6px; font-size: 11px; font-weight: 500; }');
w('.cp-tag i { font-size: 8px; color: #888; opacity: 0.8; }');
w('.cp-tag-more { font-size: 11px; color: #888; font-weight: 500; }');
w('.cp-ms-fieldset { width: 100%; border: 1px solid #d0d5dd; border-radius: 6px; padding: 6px 8px 8px; margin: 0; background: #fff; }');
w('.cp-ms-legend { font-size: 10px; font-weight: 500; color: var(--text-primary); padding: 0 4px; margin-left: -2px; line-height: 1; }');
...
w('.cp-upload { width: 100%; border: 1px dashed #d0d5dd; border-radius: 8px; padding: 16px; display: flex; flex-direction: column; align-items: center; gap: 6px; color: #888; box-sizing: border-box; }');
...
w('.cp-upload.cp-upload-inline { min-height: 40px; padding: 10px 12px; border-style: solid; border-color: rgba(187, 189, 221, 0.95); border-radius: 14px; flex-direction: row; align-items: center; justify-content: space-between; gap: 10px; color: #606189; }');
w('.cp-upload-text { font-size: 12px; color: #606189; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }');
w('.cp-upload-actions { display: inline-flex; align-items: center; gap: 8px; flex-shrink: 0; }');
w('.cp-upload.cp-upload-inline i { font-size: 14px; opacity: 1; color: #71718c; }');
...
w('.primary-color-picker { -webkit-appearance: none; appearance: none; width: 28px; height: 28px; border: 1px solid var(--border-light); border-radius: 6px; cursor: pointer; padding: 0; background: none; }');
...
w('.spacing-demo-box { background: var(--brand-lighter); border: 1px dashed var(--brand-light); border-radius: 6px; font-size: 11px; color: var(--brand-primary); font-weight: 600; text-align: center; }');
...
w('.cfg-type-card { background: #fff; border: 1px solid var(--border-light); border-radius: 14px; padding: 16px; cursor: pointer; transition: all 0.25s ease; display: flex; flex-direction: column; gap: 12px; position: relative; }');
...
/* ── Icon View ── */
w('.icon-view-tabs { display: flex; gap: 8px; margin-bottom: 24px; }');
w('.icon-view-tab { padding: 8px 20px; border: 1px solid var(--border-light); border-radius: 8px; background: #fff; font-size: 14px; font-weight: 500; color: var(--text-secondary); cursor: pointer; transition: all .2s; font-family: var(--font-family); }');
w('.icon-view-tab:hover { border-color: var(--brand-primary); color: var(--brand-primary); }');
w('.icon-view-tab.active { background: var(--brand-primary); color: #fff; border-color: var(--brand-primary); }');
w('.icon-view-tab .nav-badge { margin-left: 6px; }');
w('.icon-tab-panel { display: none; }');
w('.icon-tab-panel.active { display: block; }');
w('.icon-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 16px; }');
w('.icon-card { background: #fff; border: 1px solid var(--border-light); border-radius: 12px; padding: 16px; text-align: center; transition: all .2s; cursor: pointer; }');
w('.icon-card:hover { border-color: var(--brand-primary); box-shadow: 0 4px 16px rgba(0,0,0,0.08); transform: translateY(-2px); }');
w('.icon-card.hidden { display: none; }');
w('.icon-card-preview { font-size: 32px; margin-bottom: 12px; color: var(--text-primary); line-height: 1; }');
w('.icon-card-info { display: flex; flex-direction: column; gap: 4px; }');
w('.icon-card-name { font-size: 12px; font-weight: 600; color: var(--text-primary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }');
w('.icon-card-value { font-size: 11px; color: var(--text-tertiary); font-family: monospace; }');
w('.icon-card-tag { font-size: 10px; color: var(--text-secondary); background: var(--bg-light); padding: 4px 8px; border-radius: 6px; word-break: break-all; text-align: left; display: block; margin-top: 4px; }');
w('.icon-card-copied { position: fixed; top: 20px; left: 50%; transform: translateX(-50%); background: #1a1a2e; color: #fff; padding: 10px 24px; border-radius: 8px; font-size: 13px; font-weight: 500; z-index: 9999; pointer-events: none; animation: iconToastIn .3s ease; }');
w('@keyframes iconToastIn { from { opacity: 0; transform: translateX(-50%) translateY(-10px); } to { opacity: 1; transform: translateX(-50%) translateY(0); } }');
...
w('    <a class="nav-item" data-view="icons"><i class="fa-solid fa-icons"></i> Icons</a>');
...
w('    </a>');
w('    <a class="home-card" data-navigate="icons">');
w('      <div class="home-card-icon" style="background:linear-gradient(135deg,#F97316,#EA580C)"><i class="fa-solid fa-icons"></i></div>');
w('      <div class="home-card-content"><h3>Icons</h3><p>Outline &amp; Solid icon library</p></div>');
w('      <i class="fa-solid fa-arrow-right home-card-arrow"></i>');
w('    </a>');
...
/* ════════════════════════════════════════
   VIEW: ICONS
   ════════════════════════════════════════ */
(function generateIconsView() {
  var iconData = loadSmoothIconData();
  var outlineIcons = iconData.outline || {};
  var solidIcons = iconData.solid || {};
  var outlineKeys = Object.keys(outlineIcons);
  var solidKeys = Object.keys(solidIcons);

  w('<div class="view" id="view-icons">');
  w('  <div class="page-header">');
  w('    <div class="page-header-text">');
  w('      <h1 class="page-title">Icons</h1>');
  w('      <p class="page-description">ZC Live icon library — ' + outlineKeys.length + ' Outline and ' + solidKeys.length + ' Solid icons.</p>');
  w('    </div>');
  w('    <div class="inline-search"><i class="fa-solid fa-magnifying-glass"></i><input type="text" placeholder="Search icons..." id="iconSearchInput" autocomplete="off"></div>');
  w('  </div>');

  /* Tabs */
  w('  <div class="icon-view-tabs">');
  w('    <button class="icon-view-tab active" data-icon-tab="outline">Outline <span class="nav-badge">' + outlineKeys.length + '</span></button>');
  w('    <button class="icon-view-tab" data-icon-tab="solid">Solid <span class="nav-badge">' + solidKeys.length + '</span></button>');
  w('  </div>');

  /* Outline grid */
  w('  <div class="icon-tab-panel active" id="icon-panel-outline">');
  w('    <div class="icon-grid">');
  outlineKeys.forEach(function(name) {
    var code = outlineIcons[name];
    var className = normalizeSmoothIconClassName(name);
    w('      <div class="icon-card" data-icon-name="' + esc(className) + '">');
    w('        <div class="icon-card-preview"><i class="zc-li-outline ' + esc(className) + '"></i></div>');
    w('        <div class="icon-card-info">');
    w('          <div class="icon-card-name" title="' + esc(className) + '">' + esc(className) + '</div>');
    w('          <div class="icon-card-value">\\' + code + '</div>');
    w('          <code class="icon-card-tag">&lt;i class="zc-li-outline ' + esc(className) + '"&gt;&lt;/i&gt;</code>');
    w('        </div>');
    w('      </div>');
  });
  w('    </div>');
  ...
  /* Solid grid */
  w('  <div class="icon-tab-panel" id="icon-panel-solid">');
  w('    <div class="icon-grid">');
  solidKeys.forEach(function(name) {
    var code = solidIcons[name];
    var className = normalizeSmoothIconClassName(name);
    w('      <div class="icon-card" data-icon-name="' + esc(className) + '">');
    w('        <div class="icon-card-preview"><i class="zc-li-solid ' + esc(className) + '"></i></div>');
    w('        <div class="icon-card-info">');
    w('          <div class="icon-card-name" title="' + esc(className) + '">' + esc(className) + '</div>');
    w('          <div class="icon-card-value">\\' + code + '</div>');
    w('          <code class="icon-card-tag">&lt;i class="zc-li-solid ' + esc(className) + '"&gt;&lt;/i&gt;</code>');
    w('        </div>');
    w('      </div>');
  });
  w('    </div>');
...
w('');
w('/* ── Icon view: tab switching, search, copy ── */');
w('(function(){');
w('  var tabs = document.querySelectorAll(".icon-view-tab");');
w('  var panels = document.querySelectorAll(".icon-tab-panel");');
w('  tabs.forEach(function(tab){');
w('    tab.addEventListener("click", function(){');
w('      tabs.forEach(function(t){ t.classList.remove("active"); });');
w('      panels.forEach(function(p){ p.classList.remove("active"); });');
w('      tab.classList.add("active");');
w('      var target = document.getElementById("icon-panel-" + tab.getAttribute("data-icon-tab"));');
w('      if (target) target.classList.add("active");');
w('    });');
w('  });');
w('  /* Search */');
w('  var searchInput = document.getElementById("iconSearchInput");');
w('  if (searchInput) {');
w('    searchInput.addEventListener("input", function(){');
w('      var q = searchInput.value.toLowerCase().trim();');
w('      var cards = document.querySelectorAll("#view-icons .icon-card");');
w('      cards.forEach(function(card){');
w('        var name = card.getAttribute("data-icon-name") || "";');
w('        card.classList.toggle("hidden", q && name.indexOf(q) === -1);');
w('      });');
w('    });');
w('  }');
w('  /* Copy tag on click */');
w('  document.querySelectorAll("#view-icons .icon-card").forEach(function(card){');
w('    card.addEventListener("click", function(){');
w('      var tag = card.querySelector(".icon-card-tag");');
w('      if (!tag) return;');
w('      var text = tag.textContent;');
w('      if (navigator.clipboard) {');
w('        navigator.clipboard.writeText(text);');
w('      } else {');
w('        var ta = document.createElement("textarea");');
w('        ta.value = text; document.body.appendChild(ta); ta.select(); document.execCommand("copy"); document.body.removeChild(ta);');
w('      }');
w('      var toast = document.createElement("div");');
w('      toast.className = "icon-card-copied";');
w('      toast.textContent = "Copied: " + text;');
w('      document.body.appendChild(toast);');
w('      setTimeout(function(){ toast.remove(); }, 1500);');
w('    });');
w('  });');
w('})();');
w('');
