...
class LyteTourStepComponent extends Component {
    constructor() {
        super();
    }
    ...
    data() {
		return {
			...
			'ltPropArrowPosition'	: prop('string' , { default : 'start' }), //start , end , center
			...
			'ltPropPosition'		: prop('string' , { default : 'right' }), // right , left , top , bottom
			'ltPropScrollToView': prop('boolean' , { default : false }),
			'ltPropClass' : prop('string'),

			'arrowPositionOnBox': prop('string' , {default : 'left'}),
			'initialArrowFlag'	: prop('boolean' , {default : false})
		};
	}
    ...
    startLyteStep(th) {
		...
		if(parentTour.getData('ltPropCreateDummy')){
			...
			var border = window.getComputedStyle(tar).borderRadius;
			...
			if(tourFreeze){
				...
				clipDiv.style.width = window.getComputedStyle(tar).width
				clipDiv.style.height = window.getComputedStyle(tar).height
				clipDiv.style.borderRadius = window.getComputedStyle(tar).borderRadius
