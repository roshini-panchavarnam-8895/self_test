...
Helper.register("shouldRenderInput", function (content) {
	return this.$node.component.isFilterFullySpecified(content);
});

Helper.register("getType", function (filter) {
	if ( filter.condition ) {
