	...
	appendElement(event, prop) {
		...
		if (prop == 'span') {
			if (elem.classList.contains('lyteDragDropAdd') && this.onClickFunction(event, this.getElement(elem.parentElement), "availableList")) {
				...
				this.$addon.arrayUtils(this.getData('ltPropAvailablelist'), 'removeAt', this.getElementPosition(this.getData('ltPropAvailablelist'), element), 1);
				this.$addon.arrayUtils(this.getData('ltPropSelectedlist'), 'push', element);
				element = null;
				this.generateArray();
			...
			if (elem.classList.contains('lyteDragDropRemove') && this.onClickFunction(event, this.getElement(elem.parentElement), "selectedList")) {
				...
				element = this.getElement(elem.parentElement);
				this.$addon.arrayUtils(this.getData('ltPropSelectedlist'), 'removeAt', this.getElementPosition(this.getData('ltPropSelectedlist'), element), 1);
				this.$addon.arrayUtils(this.getData('ltPropAvailablelist'), 'push', element);
				element = null;
				this.generateArray();
				this.onDropFunction(event);
			}
