...
import { Security, Sanitizer } from "@slyte/component/src/utils/lyte-sanitizer.js";
//@Slicer.$bundlePurifierEnd
//@Slicer.$bundleEncoderStart
import { Encoder } from "@zoho/SecurityJS/dist/security-encoder.js";
//@Slicer.$bundleEncoderEnd
...
class ComponentRegistry extends Service{
    ...
    //@Slicer.$bundlePurifierStart
    static _sanitizerInstance = new Sanitizer({ 
        "GLOBAL_TAGS": [], 
        "GLOBAL_ATTRIBUTES": [],
        "FORBID_TAGS":[],
        "FORBID_ATTR":[], 
                    ...
                    if(attr && (attr.dynamicValue || attr.helperInfo)) {
                        ...
                        if(attr.helperInfo && attr.helperInfo.name === "action") {
                            ...
                            if(this._ssrBind){
                                ...
                                cmpData.bindIds.__actions = cmpData.bindIds.__actions ? cmpData.bindIds.__actions : [];
...
//            			}
                ...
                if(this._ssrBind && obj){
                    ...
                    if(lyteConvertedSwitch){
                        ...
                        [cmpData.bindIds[size-2],cmpData.bindIds[size-1]] = [cmpData.bindIds[size-1],cmpData.bindIds[size-2]];
                    ...
                    if(nodeValue && typeof nodeValue === "object"){
                        ...
                        if(typeof Record != "undefined" && nodeValue instanceof Record){
                            ...
                            try{
                                ...
                                //@Slicer.developmentStart
                                ComponentError.error(node,"LC013",node.nodeName,node.ownerElement.nodeName.toLocaleLowerCase(),node.ownerElement.nodeName.toLocaleLowerCase())
                                //@Slicer.developmentEnd
                            }
                        }
                    }
...
defHelpers["method"] = function(parentComponent, attributeNode, functionName) {
    ...
    var newFunc = function() {
        ...
        if(self._methods[functionName1]) {
           ...
           //@Slicer.developmentStart
           _LC.debugPerf(appScope,node.__renderId, "Method "+functionName1,self.constructor._compName);
           //@Slicer.developmentEnd
           //@Slicer.catchAllErrorsStart
           try{
            //@Slicer.catchAllErrorsEnd 
