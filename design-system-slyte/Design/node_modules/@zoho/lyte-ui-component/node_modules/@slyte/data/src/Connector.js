        ...
        return new Promise(function(resolve, reject){
            ...
            //@Slicer.catchAllErrorsEnd
                if(xhr){
                    ...
                    var res = initCB(db, "connector", def ? def.connector : undefined, Connector.PARSERESPONSE, { argsObj: argsObj, args:[type, name, xhr, resp, urlObj ? urlObj.qP : undefined, key, customData, opts]});
                    if(res){
                        cresp = res.data;
