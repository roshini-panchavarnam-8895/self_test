 ...
 * Figma Source: Rich_Tooltip_Core (node 2401:258)
 *
 * Handles interactive behavior for the tooltip component showcase:
 *   - Tab switching between tooltip type variants (Text, List, Table, Placement)
...
(function () {
    ...
    /* -----------------------------------------------------------------------
       SWITCH TOOLTIP STYLE TAB
       ----------------------------------------------------------------------- */
    window.switchTooltipStyleTab = function (styleKey, tabEl) {
        var container = document.getElementById('tooltip-component-variants');
        if (!container) return;
    ...
    /* -----------------------------------------------------------------------
       TOGGLE CODE PANEL
       ----------------------------------------------------------------------- */
    window.toggleTooltipCodePanel = function (btn) {
    ...
    /* -----------------------------------------------------------------------
       COPY TOOLTIP CODE
       ----------------------------------------------------------------------- */
    window.copyTooltipCode = function (btn) {
    ...
    /* -----------------------------------------------------------------------
       ...
       ----------------------------------------------------------------------- */
    window.switchTooltipCodeTab = function (tab, tabEl) {
