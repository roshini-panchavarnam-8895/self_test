...
class LyteRatingComponent extends Component {
    constructor() {
        super();
    }
    ...
    data(arg1) {
		return Object.assign(super.data({
             ...
             * @default 5
             */
			"ltPropCount" : prop("number",{"default":5}),
             ...
             * @default svg
             */
			"ltPropType" : prop("string",{"default":"svg"}),	//svg,multiple,switch,toggle,class

			/**
             * @componentProperty {star|heart|lineStar|lineHeart|smiley|likeDislike|custom} ltPropAppearance
             * @version 3.1.0
             */
			"ltPropAppearance" : prop("string"),				//star,heart,lineStar,lineHeart,smiley,likeDislike,custom
             ...
             * 
             */
			"ltPropClearable" : prop("boolean",{"default":false}),
             ...
             * 
             */
			"ltPropHalfIncrement" : prop("boolean",{"default":false}),
             ...
             */
			"ltPropEmptyIcon" : prop("string",{"default":"lyteDummyRC"}),
             ...
             */
			"ltPropFullIcon" : prop("string",{"default":"lyteDummyRC"}),
             ...
             */
			"ltPropHalfIcon" : prop("string",{"default":"lyteDummyRC"}),
             ...
             */
			"ltPropHoverFullIcon" : prop("string",{"default":"lyteDummyRC"}),
             ...
             */
			"ltPropHoverHalfIcon" : prop("string",{"default":"lyteDummyRC"}),
             ...
             * @default #c7c7c7
             */
			"ltPropEmptyColor" : prop("string",{"default":"#c7c7c7"}),
             ...
             * @default #f00
             */
			"ltPropFillColor" : prop("string",{"default":"#f00"}),
             ...
             * @default #FF7778
             */
			"ltPropHoverColor" : prop("string",{"default":"#FF7778"}),
             ...
             */
			"ltPropWidth" : prop("string",{"default":"22px"}),
             ...
             * @suffix px,pt,cm,mm,vh,vm,em
             */
			"ltPropHeight" : prop("string",{"default":"22px"}),

			/**
             * @componentProperty {string} ltPropHref
             * @version 3.1.0
             */
			"ltPropHref" : prop("string"),
             ...
             * @default 0.5
             */
			"ltPropPrecision" : prop("number",{"default":0.5}),

			/**
             * @componentProperty {string} ltPropStroke
             * @version 3.1.0
             */
			"ltPropStroke" : prop("string"),
			"countArray" : prop("array",{"default":[]}),
			"currentHover" : prop("number",{"default":0}),
			"emptyIconArray" : prop("array",{"default":[]}),
			"fullIconArray" : prop("array",{"default":[]}),
			"halfIconArray" : prop("array",{"default":[]}),
			"hoverFullIconArray" : prop("array",{"default":[]}),
			"hoverHalfIconArray" : prop("array",{"default":[]}),
			"starVB" : prop("string",{"default":"6.5 4.5 21 21"}),
			"lineStarVB" : prop("string",{"default":"5.5 2.5 23 23"}),
			"heartVB" : prop("string",{"default":"1.5 0.5 20 20"}),
			"lineHeartVB" : prop("string",{"default":"1 0 21 21"}),
			"ratingNum" : prop("number",{"default":0}),
			"ltPropPrevWrapper" : prop("string")
		}), arg1);		
	}
...
if( !window._lyteUiUtils.registeredCustomElements[ 'lyte-rate-icon' ] ){
    window._lyteUiUtils.registeredCustomElements[ 'lyte-rate-icon' ] = true;

    class LyteRateIconCustomElements extends LyteUiComponentComponentRegistry.CustomElements {
        constructor() {
            super();
        }

        connectedCallback() {
	    	if(!this.$node.prevent){
		        var comp = this.$node.closest('lyte-rating').component;
		        this.$node.addEventListener('click',comp.onClick.bind(comp));
		        this.$node.addEventListener('mousemove',comp.onOver.bind(comp));
		        this.$node.addEventListener('mouseout',comp.onOut.bind(comp));
 ...
 * </lyte-rating> 
 */
export { LyteRatingComponent };

LyteRatingComponent.register("lyte-rating", {
    hash: "LyteRatingComponent_4",
