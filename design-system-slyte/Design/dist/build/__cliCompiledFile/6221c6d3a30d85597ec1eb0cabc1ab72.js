...
LyteKanbanviewComponent._template = "<template tag-name=\"lyte-kanbanview\"> <div class=\"lyteKanbanviewScrollDivSelector {{dummyId}}\" onscroll=\"{{action('onBodyScroll',event)}}\"> <template items=\"{{ltPropBoardDetails}}\" item=\"item\" index=\"dataIndex\" is=\"for\" _new=\"true\"> <div class=\"lyteKanbanViewItem {{if(item.collapse,'lyteKanbanBoardCollapse','')}}\"> <lyte-yield yield-name=\"kanbanYield\" lyte-board-item=\"{{item}}\" lyte-index=\"{{dataIndex}}\" lyte-kanban-id=\"{{dummyId}}\"></lyte-yield> </div> </template> </div> </template>";;
LyteKanbanviewComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"i","p":[1,1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":0},{"type":"dc","trans":true,"hc":true,"p":[0]}];;
...
LyteKanbanviewComponent.register("lyte-kanbanview", {
    hash: "LyteKanbanviewComponent_4",
