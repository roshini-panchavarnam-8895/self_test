        ...
        if (tabId) {
            ...
            if (typeof tabId == "string") {
                ...
                var opentabfunc = function(){
                    ...
                    _this.setData('ltPropCurrentTab', { 'index': window.v, 'name': label.textContent.trim() });
