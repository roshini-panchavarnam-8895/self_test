...
LyteTimePickerComponent._template = "<template tag-name=\"lyte-time-picker\"> <div class=\"lyteTimePickerField\" onkeydown=\"{{action('inputKeyDown',event,this)}}\"> <input value=\"{{lbind(ltPropValue)}}\" placeholder=\"{{ltPropPlaceholder}}\" id=\"{{ltPropId}}\" class=\"lyteTimePickerInput {{ltPropClass}}\" name=\"{{ltPropName}}\" readonly=\"{{ltPropReadonly}}\" disabled=\"{{ltPropDisabled}}\" aria-label=\"{{ltPropAriaAttributes.input}}\" aria-invalid=\"{{invalidValue}}\" onfocus=\"{{action('inputFocus',event,this,true)}}\" onblur=\"{{action('inputFocus',false)}}\" oninput=\"{{action('inputVal')}}\"> <template is=\"switch\" l-c=\"true\" _jsp=\"true\"><template is=\"case\" case=\"{{ltPropDropdown}}\" lc-id=\"lc_id_0\"> <button class=\"lytetimePickerButton\" aria-label=\"{{ltPropAriaAttributes.icon}}\" disabled=\"{{ltPropDisabled}}\" aria-expanded=\"false\" aria-haspopup=\"true\" aria-controls=\"{{randId}}\" tabindex=\"0\"> <span class=\"lyteTimePickerBtnIcon\"></span> </button> </template></template> <template is=\"switch\" l-c=\"true\" _jsp=\"true\"><template is=\"case\" case=\"{{ltPropCounter}}\" lc-id=\"lc_id_0\"> <div class=\"lytetimePickerCounterButtons\"> <button class=\"lytetimePickerIncButton\" aria-label=\"{{ltPropAriaAttributes.inc}}\" disabled=\"{{ltPropDisabled}}\" onmousedown=\"{{action('counterKeys',true)}}\" ontouchstart=\"{{action('counterKeys',true,true)}}\" tabindex=\"-1\"> <span class=\"lyteTimePickerIncIcon\"></span> </button> <button class=\"lytetimePickerDecButton\" aria-label=\"{{ltPropAriaAttributes.dec}}\" disabled=\"{{ltPropDisabled}}\" onmousedown=\"{{action('counterKeys')}}\" ontouchstart=\"{{action('counterKeys',false,true)}}\" tabindex=\"-1\"> <span class=\"lyteTimePickerDecIcon\"></span> </button> </div> </template></template> </div> <lyte-time-picker-dropdown id=\"{{randId}}\" class=\"lyteTimePickerDropdownNone\" onkeydown=\"{{action('dropDownKeyDown',event,this)}}\"> <div class=\"lyteTimePickerDropdownValues\" onfocusin=\"{{action('dropDownValueFocus',event,true)}}\" onfocusout=\"{{action('dropDownValueFocus',event,false)}}\"> <template is=\"switch\" l-c=\"true\" _jsp=\"true\"><template is=\"case\" case=\"{{hours.length}}\" lc-id=\"lc_id_0\"> <ul class=\"lyteTimePickerUl\" data-unit=\"hours\" aria-label=\"{{ltPropAriaAttributes.hour}}\"> <template is=\"for\" _jsp=\"true\" items=\"{{hours}}\" item=\"item\" index=\"index\"> <li class=\"{{item.class}}\" tabindex=\"0\" data-index=\"{{item.index}}\" data-unit=\"hours\" role=\"options\" aria-selected=\"{{item.selected}}\" aria-disabled=\"{{item.disabled}}\" aria-label=\"{{item.value}}\" data-value=\"{{item.value}}\">{{item.value}}</li> </template> </ul> </template></template> <template is=\"switch\" l-c=\"true\" _jsp=\"true\"><template is=\"case\" case=\"{{minutes.length}}\" lc-id=\"lc_id_0\"> <ul class=\"lyteTimePickerUl\" data-unit=\"minutes\" aria-label=\"{{ltPropAriaAttributes.minute}}\"> <template is=\"for\" _jsp=\"true\" items=\"{{minutes}}\" item=\"item\" index=\"index\"> <li class=\"{{item.class}}\" tabindex=\"0\" data-index=\"{{item.index}}\" data-unit=\"minutes\" role=\"options\" aria-selected=\"{{item.selected}}\" aria-disabled=\"{{item.disabled}}\" aria-label=\"{{item.value}}\" data-value=\"{{item.value}}\">{{item.value}}</li> </template> </ul> </template></template> <template is=\"switch\" l-c=\"true\" _jsp=\"true\"><template is=\"case\" case=\"{{seconds.length}}\" lc-id=\"lc_id_0\"> <ul class=\"lyteTimePickerUl\" data-unit=\"seconds\" aria-label=\"{{ltPropAriaAttributes.second}}\"> <template is=\"for\" _jsp=\"true\" items=\"{{seconds}}\" item=\"item\" index=\"index\"> <li class=\"{{item.class}}\" tabindex=\"0\" data-index=\"{{item.index}}\" data-unit=\"seconds\" role=\"options\" aria-selected=\"{{item.selected}}\" aria-disabled=\"{{item.disabled}}\" aria-label=\"{{item.value}}\" data-value=\"{{item.value}}\">{{item.value}}</li> </template> </ul> </template></template> <template is=\"switch\" l-c=\"true\" _jsp=\"true\"><template is=\"case\" case=\"{{meridiems.length}}\" lc-id=\"lc_id_0\"> <ul class=\"lyteTimePickerUl\" data-unit=\"meridiems\" aria-label=\"{{ltPropAriaAttributes.meridiem}}\"> <template is=\"for\" _jsp=\"true\" items=\"{{meridiems}}\" item=\"item\" index=\"index\"> <li class=\"{{item.class}}\" tabindex=\"0\" data-index=\"{{item.index}}\" data-unit=\"meridiems\" role=\"options\" aria-selected=\"{{item.selected}}\" aria-disabled=\"{{item.disabled}}\" aria-label=\"{{item.value}}\" data-value=\"{{item.value}}\">{{item.value}}</li> </template> </ul> </template></template> </div> <div class=\"lyteTimePickerDropdownButton\"> <template is=\"for\" _jsp=\"true\" items=\"{{ltPropButton}}\" item=\"item\" index=\"index\"> <lyte-button class=\"lyteTimePickerDropdownButtonItem\" purpose=\"{{item.purpose}}\" lt-prop=\"{{stringify(item.properties)}}\" lt-prop-aria-button=\"{{item.properties.ariaButton}}\" onfocus=\"{{action('customButtonFocus',event,this)}}\"> <template is=\"registerYield\" yield-name=\"text\"> {{item.text}} </template> </lyte-button> </template> </div> </lyte-time-picker-dropdown> </template>";;
LyteTimePickerComponent._dynamicNodes = [{"t":"a","p":[1]},{"t":"a","p":[1,1]},{"t":"s","p":[1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":7,"sibl":[6]},{"t":"s","p":[1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"a","p":[1,3],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":6,"sibl":[5]},{"t":"a","p":[3]},{"t":"a","p":[3,1]},{"t":"s","p":[3,1,1],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":5,"sibl":[4]},{"t":"s","p":[3,1,3],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":4,"sibl":[3]},{"t":"s","p":[3,1,5],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":3,"sibl":[2]},{"t":"s","p":[3,1,7],"c":{"lc_id_0":{"dN":[{"t":"a","p":[1],"cn":"lc_id_0"},{"t":"a","p":[1,1],"cn":"lc_id_0"},{"t":"f","p":[1,1],"dN":[{"t":"a","p":[1]},{"t":"tX","p":[1,0]}],"cn":"lc_id_0"}],"cdp":{"t":"a","p":[0]},"dcn":true}},"d":{},"dc":{"lc_id_0":{}},"hd":true,"co":["lc_id_0"],"in":2,"sibl":[1]},{"t":"a","p":[3,3,1]},{"t":"f","p":[3,3,1],"dN":[{"t":"a","p":[1]},{"t":"r","p":[1,1],"dN":[{"t":"tX","p":[1]}],"in":1,"sibl":[0]},{"t":"cD","p":[1],"in":0}],"dc":[0],"hc":true,"trans":true,"in":1,"sibl":[0]},{"t":"cD","p":[3],"in":0},{"type":"dc","trans":true,"hc":true,"p":[1,0]}];;
