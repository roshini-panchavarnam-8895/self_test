/**
 * INPUT OTP COMPONENT — JavaScript
 * Figma Source: Input_OTP (node 2764:6839)
 *
 * Handles interactive behavior for the Input OTP component showcase:
 *   - Tab switching between OTP state variants
...
(function () {
    ...
    /* -----------------------------------------------------------------------
       SWITCH INPUT OTP STYLE TAB
       ----------------------------------------------------------------------- */
    window.switchInputOtpStyleTab = function (styleKey, tabEl) {
        var container = document.getElementById('input-otp-component-variants');
        if (!container) return;
    ...
    /* -----------------------------------------------------------------------
       TOGGLE INPUT OTP CODE PANEL
       ----------------------------------------------------------------------- */
    window.toggleInputOtpCodePanel = function (btn) {
    ...
    /* -----------------------------------------------------------------------
       COPY INPUT OTP CODE
       ----------------------------------------------------------------------- */
    window.copyInputOtpCode = function (btn) {
    ...
    /* -----------------------------------------------------------------------
       ...
       ----------------------------------------------------------------------- */
    window.switchInputOtpCodeTab = function (tab, tabEl) {
