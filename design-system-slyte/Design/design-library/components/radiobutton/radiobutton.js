(function () {
    'use strict';
    window.switchRadioStyleTab = function (styleKey, tabEl) {
        var container = document.getElementById('radio-component-variants');
        if (!container) return;
    ...
    window.toggleRadioCodePanel = function (btn) {
    ...
    window.copyRadioCode = function (btn) {
    ...
    window.switchRadioCodeTab = function (tab, tabEl) {
